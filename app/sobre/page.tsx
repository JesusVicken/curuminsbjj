          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mb-16 text-center max-w-3xl mx-auto">
              <span className="text-xs font-bold tracking-widest text-red-accent uppercase">
                {isEn ? "Village Reality" : "A Realidade da Aldeia"}
              </span>
              <h2 className="mt-4 font-display text-3xl font-extrabold tracking-tight text-white uppercase">
                {isEn ? "Our Environment" : "Nosso Ambiente"}
              </h2>
              <p className="mt-4 text-zinc-400 font-light text-lg">
                {isEn
                  ? "It is within the simplicity of our dojo that the community's true strength resides. We train alongside nature, where every donated kimono and mat represents tangible hope."
                  : "É na simplicidade da estrutura que mora a força da nossa comunidade. Treinamos com a natureza, e cada quimono doado, cada tatame montado representa esperança."}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="rounded-3xl overflow-hidden border border-white/10 shadow-2xl h-80 relative group">
                ...
                <div className="absolute bottom-6 left-6 text-white font-bold uppercase tracking-widest text-xs">
                  {isEn ? "Team Practice" : "Treino Coletivo"}
                </div>
              </div>
              <div className="rounded-3xl overflow-hidden border border-white/10 shadow-2xl h-80 relative group">
