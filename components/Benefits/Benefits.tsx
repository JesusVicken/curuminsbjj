    ...
    ? [
        {
          ...
          description:
            "The fundamental pillar of the gentle art. We teach the importance of honoring tribal leaders, respecting the rules of the mat, and cultivating patience in every session.",
        },
        {
          iconName: "Award" as const,
          title: "Courage & Resilience",
          description:
            "We build mental and physical grit. Every knockdown teaches the child to rise with courage and determination, pursuing lifelong self-improvement.",
        },
        {
          iconName: "Heart" as const,
          title: "Social Responsibility",
          description:
            "The tatami instills collective duty. Children understand that their daily conduct directly influences the harmony and strength of the village.",
        },
        {
          iconName: "Users" as const,
          title: "Self-Esteem & Dreams",
          description:
            "We teach that indigenous heritage and economic hardship do not limit human potential. Jiu-Jitsu empowers children to believe in their highest aspirations.",
        },
      ]
    : [
        {
        ...
        <div className="mx-auto max-w-3xl text-center mb-20">
          <FadeIn direction="up">
            <span className="text-xs font-bold tracking-widest text-red-accent uppercase">
              {isEn ? "Martial Arts Values" : "Valores da Arte Marcial"}
            </span>
            <h2 className="mt-6 font-display text-3xl font-extrabold tracking-tight text-white sm:text-5xl leading-[0.95] uppercase">
              {isEn ? "Forging champions in real life" : "Formando vencedores na vida real"}
            </h2>
            <p className="mt-4 text-base text-zinc-400 max-w-2xl mx-auto font-light">
              {isEn
                ? "For indigenous youth, Brazilian Jiu-Jitsu represents opportunity, inclusion, and a profoundly positive future, instilling lifelong character virtues."
                : "Para muitos curumins, o jiu-jitsu representa oportunidade, inclusão e um caminho extremamente positivo para o futuro, desenvolvendo virtudes fundamentais."}
            </p>
          </FadeIn>
        </div>
