    ...
    <footer className="bg-zinc-950 border-t border-white/5 pt-20 pb-8">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-12 border-b border-white/5">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 max-w-sm">
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/p/DLNeztiRXTF/" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-red-accent/20 transition-all duration-300">
                <Icons.Instagram className="h-4 w-4" />
              </a>
              <a href="https://youtu.be/cXyml43QBDY" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-red-accent/20 transition-all duration-300">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 text-[10px] text-zinc-500 uppercase tracking-widest font-semibold">
          <p>&copy; {new Date().getFullYear()} Instituto Projeto Curumins BJJ. {t.footer.rights}</p>
          <p>
            {t.footer.slogan}
          </p>
        </div>
