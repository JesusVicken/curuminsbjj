            ...
            <FadeIn direction="left">
              ...
              <ul className="mt-8 space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-bold tracking-wide uppercase text-sm">{t.structure.safeSpaceTitle}</h3>
                    <p className="mt-2 text-sm text-zinc-400 leading-relaxed font-light">{t.structure.safeSpaceDesc}</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-zinc-900 border border-white/10 text-red-accent">
                  ...
                  <div>
                    <h3 className="text-white font-bold tracking-wide uppercase text-sm">{t.structure.matTitle}</h3>
                    <p className="mt-2 text-sm text-zinc-400 leading-relaxed font-light">{t.structure.matDesc}</p>
                  </div>
                </li>
              </ul>
            </FadeIn>
